...
// patient has logged; an unauthenticated viewer MUST NOT be able to
// retrieve it. The prior EXPORT_ADMIN_TOKEN + `?token=` query pattern
// was retired this sweep (D-008): query strings land in browser
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const message = err instanceof Error ? err.message : 'Full export failed'
