...
import { AnimatedNumber, MetricRing, SpringValue } from '@/v2/components/primitives'
    ...
    >
      ...
      >
        <MetricRing
          ...
          label={cfg.label}
          displayValue={
            <SpringValue value={lastNight.sleep_score}>
              <AnimatedNumber value={lastNight.sleep_score} duration={1.4} />
            </SpringValue>
          }
        />
      </button>
